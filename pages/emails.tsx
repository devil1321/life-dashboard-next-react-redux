        ...
        <div className="emails">
          ...
          <div className="emails__emails-wrapper">
            <div className="emails__emails">
              {!isPreview && !isReply && tempArr.map((el:any) =>  <EmailItem isView={true} img="/assets/user.png" person="Janette McGreed" subject="Blog Site" date="2022-02-28" />)}
              {isPreview && !isReply &&
                <div className="emails__preview-item">
                  ...
                  <div className="emails__preview-controls">
                    <button className="emails__reply-btn">Reply</button>
                    <button className="emails__hide-btn">Hide</button>
                  </div>
                </div>
              }
              {isReply && !isPreview && 
                <div className="emails__reply-item">
                  <div className="emails__reply-field">
